...
class ReplayMemory:
    ...
    def store(self, state, action, next_state, reward, done, next_action):
        """
    ...
    def sample(self, batch_size):
        ...
        return states, actions, next_states, rewards, dones, next_actions
...
class DQN_Agent:
    ...
    def learn(self, batch_size, done):
        ...
        states, actions, next_states, rewards, dones, next_actions = self.replay_memory.sample(batch_size)
...
class Model_TrainTest:
    ...
    def train(self): 
        ...
        for episode in range(1, self.max_episodes+1):
            ...
            while not done and not truncation:
                ...
                self.agent.replay_memory.store(state, action, next_state, reward, done, next_action) 
                ...
                epsilon_history.append(self.agent.epsilon_max)
                step_size +=1
            ...
            print(result)
        self.plot_training(episode, epsilon_history)
    ...
    def plot_training(self, episode, epsilon_history):
        ...
        plt.figure()
        plt.title("Epsilon")
        plt.plot(epsilon_history, label='Epsilon', color='#AB395A', alpha=1)
        plt.xlabel("Episode")
        plt.ylabel("Epsilon")
